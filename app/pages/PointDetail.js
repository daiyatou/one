...
export default class PointDetail extends Component {
  render() {
    return (
      ...
      >
        <ScrollView style={styles.scroll_body} tabLabel='积分使用明细' >
            <TradeItem name='购买扣除' datatime ='2016-08-08' balance='余额：￥32536.00' blueNum='￥21022.00' />
            <View style={[styles.top_line,styles.center_line]}></View>
            <TradeItem name='订单积分' datatime ='2016-08-08' balance='余额：￥32536.00' greenNum='￥21022.00' />
            <View style={[styles.top_line,styles.center_line]}></View>
            <TradeItem name='订单积分' datatime ='2016-08-08' balance='余额：￥32536.00' greenNum='￥21022.00' />
            <View style={[styles.top_line,styles.center_line]}></View>
            <TradeItem name='订单积分' datatime ='2016-08-08' balance='余额：￥32536.00' blueNum='￥21022.00' />
            <View style={[styles.top_line,styles.center_line]}></View>
            <TradeItem name='购买扣除' datatime ='2016-08-08' balance='余额：￥32536.00' blueNum='￥21022.00' />
            <View style={[styles.top_line,styles.center_line]}></View>
            <TradeItem name='订单积分' datatime ='2016-08-08' balance='余额：￥32536.00' blueNum='￥21022.00' />
        ...
        <ScrollView style={styles.scroll_body} tabLabel='保证金利息明细' >
            <TradeItem name='保证金利息' datatime ='2016-08-08' balance='余额：￥32536.00' blueNum='￥21022.00' />
            <View style={[styles.top_line,styles.center_line]}></View>
            <TradeItem name='保证金利息' datatime ='2016-08-08' balance='余额：￥32536.00' greenNum='￥21022.00' />
            <View style={[styles.top_line,styles.center_line]}></View>
            <TradeItem name='保证金利息' datatime ='2016-08-08' balance='余额：￥32536.00' greenNum='￥21022.00' />
            <View style={[styles.top_line,styles.center_line]}></View>
            <TradeItem name='保证金利息' datatime ='2016-08-08' balance='余额：￥32536.00' blueNum='￥21022.00' />
