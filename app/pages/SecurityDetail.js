...
export default class SecurityDetail extends Component {
  render() {
    return (
      ...
      >
        <ScrollView style={styles.scroll_body} tabLabel='保障金明细' >
          <TradeItem name='用户充值（在线充值）' datatime ='2016-08-08' balance='余额：￥32536.00' blueNum='￥21022.00' />
          ...
          <View style={[styles.top_line,styles.center_line]}></View>
          <TradeItem name='余额利息' datatime ='2016-08-08' balance='余额：￥32536.00' blueNum='￥21022.00' />
          <View style={[styles.top_line,styles.center_line]}></View>
